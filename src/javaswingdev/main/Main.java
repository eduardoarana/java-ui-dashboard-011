    ...
    private void init() {
        ...
        menu.addEvent(new EventMenuSelected() {
            ...
            public void menuSelected(int index, int indexSubMenu) {
                System.out.println("INDEX"+index +"SubMenu" +indexSubMenu );
                if (index == 0 && indexSubMenu == 0) {
                    showForm(new Form_Dashboard());
                } 
                else  if (index == 1 && indexSubMenu ==1)
                {
                     showForm(new VistaFTP(""));
                } else  if (index == 2 && indexSubMenu ==1)
                {
                     showForm(new VistaUsuario(""));
                }else  if (index ==3 && indexSubMenu ==1)
                {
                     showForm(new VistaInventario());
                }
                // Factura de Ventas 4 -1
...
//                }
                ...
                {
                    showForm(new VistaFacturaCompras(""));
                }
            }
        });
    ...
    private void initComponents() {
        ...
        panelMenuLayout.setVerticalGroup(
            panelMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(menu, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 752, Short.MAX_VALUE)
        );

        body.setOpaque(false);
        body.setLayout(new java.awt.BorderLayout());

        titleBar.setToolTipText("Cerrar , Minimizar , Maximiiiiii");
        ...
        backgroundLayout.setHorizontalGroup(
            ...
            .addGroup(backgroundLayout.createSequentialGroup()
                ...
                .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(titleBar, javax.swing.GroupLayout.DEFAULT_SIZE, 1114, Short.MAX_VALUE)
