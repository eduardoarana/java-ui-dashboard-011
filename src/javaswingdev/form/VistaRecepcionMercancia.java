...
public class VistaRecepcionMercancia extends javax.swing.JPanel {
    ...
    private VistaFacturaCompras vista;

    public VistaRecepcionMercancia(String name) {
        initComponents();
//        controller = new RecepcionMercanciaController(this);
controller = new RecepcionMercanciaController(vista);
...
//        dialoChequearArchivos.setVisible(true);
    ...
    private void btnAceptar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptar1ActionPerformed
        ...
        int[] filasSeleccionadas = jTableListaArchivos.getSelectedRows();
        for (int filaSeleccionada : filasSeleccionadas) {
            ...
            try {
                ...
                File archivo = new File("C:\\DescargasArchivoFTP\\" + archivoSeleccionado);
...
//                        facturaRenglonBO.setOferta1(vectoCadena[16]);
                ...
                Logger.getLogger(VistaRecepcionMercancia.class.getName()).log(Level.SEVERE, null, ex);
...
//       jtablePrincipalMercancia.
    ...
    public void conectarDescargarArchivo(String archivo) {
        ...
        String localFilePath = "C:\\DescargasArchivoFTP\\" + archivo;
