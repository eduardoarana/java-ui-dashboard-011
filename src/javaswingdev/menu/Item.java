...
public class Item extends JButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (!mainMenu) {
            ...
            if (isSelected()) {
                Graphics2D g2 = (Graphics2D) g.create();
                g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                g2.setPaint(new GradientPaint(0, 5, SystemColor.MAIN_COLOR_1, 5, getHeight() - 6, SystemColor.MAIN_COLOR_2));
    ...
    public void setGoogleIcon(GoogleMaterialDesignIcon icon) {
        if (icon != null) {
            this.icon = icon;
            setIcon(new GoogleMaterialIcon(icon, GradientType.HORIZONTAL, SystemColor.MAIN_COLOR_1, SystemColor.MAIN_COLOR_2, 20).toIcon());
        }
    }
